...
## Q: IS THIS ART?
A: The repo's README is now signed with a 4096-bit PGP key that decrypts to "NO"

## Q: WHY WOULD YOU DO THIS?
A: `git blame $(whoami) | grep -A 1 "existential"`

## Q: CAN I CONTRIBUTE?
A: ```diff
Unfortunately no, because:
+ The CLA requires tattooing the codebase on your thigh
